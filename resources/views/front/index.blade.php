                        ...
                        <div class="blog-left-content">
                            ...
                            <div class="single-blog">
                                <div class="blog-image">
                                    <a class="image-scale" href="{{url('blog_details/'.str_replace(' ','_',$blog->title).'/'.$blog->id)}}">
                                ...
                                <div class="blog-content">
                                    ...
                                    <a href="{{url('blog_details/'.str_replace(' ','_',$blog->title).'/'.$blog->id)}}">
                                        <h4>{{$blog->title}}</h4>
                                    </a>
                                    <p>{{$blog->description}}</p>
                                    <a class="read-more" href="{{url('blog_details/'.str_replace(' ','_',$blog->title).'/'.$blog->id)}}"> Read more</a>
                                </div>
                            </div>
                            <!-- End single blog -->
                            @endforeach
