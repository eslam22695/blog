                    ...
                    <table class="table table-bordered table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>Description</td>
                                <td>
                                    <textarea id="textarea" name="description" class="form-control" maxlength="500" rows="2">{{old('description')}}</textarea>
                            ...
                            <tr>
                                <td>Image</td>
                                <td>
                                    <input type="file" name="image" class="filestyle" data-placeholder="No file" data-iconname="fa fa-cloud-upload" required>
                                    @if ($errors->has('image'))
                                        <div class="alert alert-danger">
